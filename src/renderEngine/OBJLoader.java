...
public class OBJLoader {
    ...
    private static boolean hasNormals = true;
    public static RawModel loadObjModel(String fileName, Loader loader){
        FileReader fr = null;
        try {
            fr = new FileReader(new File("res/"+fileName));
        } catch (FileNotFoundException e) {
            System.err.print("Could not load OBJ file!");
            e.printStackTrace();
        }
    ...
    private static void processVertex(
        ...
        if(hasNormals){
            ...
            normalsArray[currentVertexPosition*3] = 0;
            normalsArray[currentVertexPosition*3+1] = 1;
            normalsArray[currentVertexPosition*3+2] = 0;
        }
